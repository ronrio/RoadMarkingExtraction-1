...
single_file=~/Downloads/Toronto-3D-Partitioning/PCD-files/Toronto_P3_000.pcd
ground_truth_file=~/Downloads/Toronto-3D-Partitioning/PCD-files/Toronto_P3_000.txt
